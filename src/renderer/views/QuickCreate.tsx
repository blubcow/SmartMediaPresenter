...
import QuickCreateMediaDropBox from './components/QuickCreateMediaDropBox/QuickCreateMediaDropBox';
import QuickCreateSlidesBox from './components/QuickCreateSlidesBox/QuickCreateSlidesBox';
